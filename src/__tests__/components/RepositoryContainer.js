import RepositoryListContainer from "../../componets/RepositoryListContainer";
...
describe('RepositoryList', () => {
  describe('RepositoryListContainer', () => {
    it('renders repository information correctly', () => {
      ...
      expect(firstRepositoryItem).toHaveTextContent('1.6k'); // 1619 forks count, formatted
      expect(firstRepositoryItem).toHaveTextContent('21.9k'); // 21856 stargazers count, formatted
      ...
      expect(secondRepositoryItem).toHaveTextContent('1.8k'); // 1760 stargazers count, formatted
